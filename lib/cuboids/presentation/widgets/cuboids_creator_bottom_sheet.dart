...
class CuboidsCreatorBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CuboidsCreatorBottomSheet> createState() => _CuboidsCreatorBottomSheetState();
}

class _CuboidsCreatorBottomSheetState extends ConsumerState<CuboidsCreatorBottomSheet> {
  ...
  Widget build(BuildContext context) {
    final cuboidPreviewSectionHeight = MediaQuery.of(context).size.height * 0.35;
    ...
    final isCuboidFormValid = ref.watch(cuboidFormProvider.notifier).getIfCuboidFormIsValid();
    final isActiveFaceFormValid = ref.watch(cuboidFormProvider.notifier).getIfFaceFormIsValid(activeFace);
    final isCuboidFormEmpty = ref.watch(cuboidFormProvider.notifier).getIfEmpty();
              ...
              children: [
                ...
                Directionality(
                  ...
                  child: TextButton.icon(
                    onPressed: isActiveFaceFormValid && activeFaceIndex < CuboidFaceDirection.values.length - 1
  ...
  Widget _buildFormPageView(
    ...
    return PageView(
      ...
      padEnds: false,
      onPageChanged: (value) => ref.read(activeFaceIndexProvider.notifier).state = value,
      children: List.generate(
        ...
        (index) => SingleChildScrollView(
          ...
          child: CuboidFaceForm(
            ...
            formData: cuboidFormData[CuboidFaceDirection.values[index]] ?? const CuboidFaceFormData(),
            onChanged: (newFormData) => ref.read(cuboidFormProvider.notifier).updateFaceFormData(
